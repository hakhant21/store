<x-guest-layout>
<div class="max-w-lg mx-auto bg-gray-800 flex items-center justify-center px-5 py-12">
    <div class="bg-gray-800 text-gray-200 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            <x-login-svg />
            <div class="w-full  py-10 px-5 md:px-10">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-200 mb-4">Login</h1>
                ...
                <div class="flex -mx-3">
                    ...
                    <div class="flex -mx-3">
                        <label for="remember_me" class="inline-flex items-center ml-4 pr-4">
                            ...
                            <span class="text-sm text-gray-200 pl-2"> {{ __('Remember me') }}</span>
                        </label>
                    </div>
